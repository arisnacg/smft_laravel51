...
@section('content')
    <h2 class="mb-4"><i class="fa fa-user"></i> Jenis Kelamin</h2>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-edit"></i> Edit Jenis Kelamin</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="{{ route('admin.jenis-kelamin-update', $jenis_kelamin->id) }}" method="POST">
                                                        <div class="modal-body">
                                                            @csrf
                                                            {{ method_field('put') }}
                                                            <div class="form-group col-md-5">
                                                                <label for="tahun">Jenis Kelamin</label>
                                                                <input class="form-control" type="text" name="tahun" id="tahun" placeholder="Tahun" value="{{ $jenis_kelamin->nama }}">
                                                            </div>
                                        ...
                                        <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('admin.jenis-kelamin-destroy', $jenis_kelamin->id) }}" method="POST">
                                                        <div class="modal-body">
                                                            @csrf
                                                            {{ method_field('delete') }}
                                                            Apakah Anda yakin menghapus jenis kelamin <b>{{ $jenis_kelamin->nama }}?</b>
