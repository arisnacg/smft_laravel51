    ...
    <div class="jumbotron jumbotron-fluid" style="background: #3C3B3F; background: -webkit-linear-gradient(to top, #605C3C, #3C3B3F);  background: linear-gradient(to top, #605C3C, #3C3B3F); height: 100vh;">
        <div class="container" style="margin-top: 10vh">
            <div class="text-center">
                <img class="img-fluid mx-auto" src="{{ asset('/img/xlogosd.png') }}" style="max-height:70vh;" alt="">
            </div>
        </div>
    </div>
    ...
    <main id="main">
                ...
                <section id="facts">
                    <div class="container wow fadeIn">
                        ...
                        <div>
                            ...
                            <span class="font-italic"><b>LOGIN.</b></span> Login dapat dilakukan menggunakan NIM dan password yang telah diberikan.
                            <br>
                            <br>
        ...
        <div class="col-md-4" style="padding: 80px 20px">
            ...
            @if(count($data))
                ...
                @endforeach
                <a href="{{ route('sd-pengumuman.index') }}" style="border-radius:50px;" class="btn btn-secondary">Lebih banyak..</a> <!-- End Pengumuman -->
            @else
