...
<html>
	...
	<body>
		<table class="tabel1">
			...
			<tr>
				<td style='text-align: center; font-size:20px;'>STUDENT DAY 2018</td>
			</tr>
			<tr>
		...
		<table class="tabel2">
			...
			<tr>
				<td rowspan="8" colspan="2" style='vertical-align: top; padding-left: 50px; border-style: none;'><img src="img/foto3x4.jpg" alt="" height=150px width=120px></td>
				<td colspan="5" style='text-align: center; border-style: none;'>Denpasar, ___________________2018</td>
			</tr>
			<tr>
